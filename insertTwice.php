    ...
    try{
      if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if($row > 0){
          ...
          email, phone, gender) VALUES('$fname1', '$lname1', '$email1', '$phone1', '$gender1')");
          $stmt2->execute();
          $stmt3 = $con->prepare("INSERT INTO students(fname, lname,
          email, phone, gender) VALUES('$fname2', '$lname2', '$email2', '$phone2', '$gender2')");
          $stmt3->execute();
